        ...
        <div className="hidden md:flex items-center gap-8">
          {navLinks.map((link) => (
            <Link
              ...
              style={{
                color: pathname === link.href ? "#32cd32" : "#07503c",
                fontFamily: "var(--font-montserrat)",
              }}
              onMouseEnter={(e) => (e.currentTarget.style.color = "#32cd32")}
              onMouseLeave={(e) =>
                (e.currentTarget.style.color =
                  pathname === link.href ? "#32cd32" : "#07503c")
              }
            >
              {link.label}
            </Link>
      ...
      {menuOpen && (
        ...
        >
          ...
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-2 px-5 py-3 text-sm font-bold rounded-full mt-1"
            style={{
              backgroundColor: "#25D366",
              color: "#ffffff",
              fontFamily: "var(--font-montserrat)",
