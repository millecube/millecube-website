...
const serviceLinks = [
  ...
  { label: "Media Advertisement", href: "/services/media-advertisement" },
...
const socialLinks = [
  {
    name: "Facebook",
    href: "https://facebook.com/millecube",
    icon: (
  ...
  {
    name: "Instagram",
    href: "https://instagram.com/millecube",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "LinkedIn",
    href: "https://linkedin.com/company/millecube",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
...
export default function Footer() {
  return (
    <footer style={{ backgroundColor: "#07503c" }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        >
          ...
          <div className="col-span-2 lg:col-span-4 flex flex-col gap-5">
            ...
            >
              Technical-first digital marketing agency from Penang. Meta Ads, Google Ads, and marketplace management — tracked to every ringgit.
            </p>
            {/* Social icons */}
          ...
          <div className="col-span-2 lg:col-span-3">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                ...
                >
                  Gat Lebuh Macallum,<br />10300 George Town, Penang
                </p>
              </li>
            </ul>
          </div>
        ...
        <div className="py-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          >
            © {new Date().getFullYear()} Cadoo Venture Sdn. Bhd. (202301026716) · All Rights Reserved
          </p>
          <div className="flex gap-5">
            {[{ label: "Privacy Policy", href: "/privacy" }, { label: "Terms of Use", href: "/terms" }].map((l) => (
              <Link
                key={l.label}
                href={l.href}
                className="text-xs transition-colors duration-200"
